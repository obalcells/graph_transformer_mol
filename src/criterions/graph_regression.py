...
class GraphRegressionL1Loss(FairseqCriterion):
    """
...
@register_criterion("m_graph_regression")
class GraphRegressionCriterion(FairseqCriterion):
    """
    ...
    def forward(self, model, sample, reduce=True):
        ...
        # we now use cosine similarity for regularization
